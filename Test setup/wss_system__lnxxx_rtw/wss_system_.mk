...
#
# File    : wss_system_.mk   $Revision: 1.81.4.21 $
#
# Abstract:
...
MODEL                = wss_system_
MODULES              = rtGetInf.c rtGetNaN.c rt_logging.c rt_look.c rt_look1d.c rt_matrx.c rt_nonfinite.c rt_printf.c wss_system__data.c 
MAKEFILE             = wss_system_.mk
MATLAB_ROOT          = /home/pppc/MATLAB/R2012a
ALT_MATLAB_ROOT      = /home/pppc/MATLAB/R2012a
S_FUNCTIONS          = sfun_comedi_ai.c sfun_comedi_ao.c sfun_comedi_do.c
S_FUNCTIONS_LIB      = /usr/lib/libcomedi.a /usr/lib/x86_64-linux-gnu/libm.a
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 0
COMPUTER             = GLNXA64
BUILDARGS            = USER_SRCS="comedi_lib.c" GENERATE_REPORT=0 COMEDI_SUPPORT=1 MYSQL_SUPPORT=0 EXT_MODE_MEX_FILE="ext_comm" EXT_MODE_MEX_FILE_ARGS="127.0.0.1"
MULTITASKING         = 0
EXT_MODE             = 1
...
ADD_INCLUDES = \
	-I/home/pppc/17gr830/Parameter_estimation/new_filter_PI/wss_system__lnxxx_rtw \
	-I/home/pppc/17gr830/Parameter_estimation/new_filter_PI \
	-I$(MATLAB_ROOT)/toolbox/comedi \
...
#----------------------------- External mode, borrowed from ert -----------------------------------
# Uncomment -DVERBOSE to have information printed to stdout
# To add a new transport layer, see the comments in
#   <matlabroot>/toolbox/simulink/simulink/extmode_transports.m
#ifeq ($(EXT_MODE),1)
...
#----------------------------- Comedi Support ---------------------------------
ifeq ($(COMEDI_SUPPORT),1)
	SYSLIBS += -lcomedi
endif

#----------------------------- MySQL Support ---------------------------------
ifeq ($(MYSQL_SUPPORT),1)
	SYSLIBS += -lz -I/usr/include/mysql -L/usr/lib/mysql
	ENDLIBS += -lmysqlclient
endif
...
ifeq ($(MODELREF_TARGET_TYPE), NONE)
    ...
    SRCS               += $(MODEL).c lnxxx_main.c rt_sim.c $(EXT_SRC) $(SOLVER)
else
...
LINT_SRCS = $(MATLAB_ROOT)/rtw/c/lnxxx/lnxxx_main.c \
...
$(PRODUCT) : $(OBJS) $(SHARED_LIB) $(LIBS) $(MODELREF_LINK_LIBS)
	$(BIN_SETTING) $(LINK_OBJS) $(MODELREF_LINK_LIBS) $(SHARED_LIB) $(LIBS) $(ENDLIBS)
...
%.o : $(MATLAB_ROOT)/toolbox/comedi/%.c
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $<
...
%.o : $(MATLAB_ROOT)/rtw/c/src/%.cpp
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) $<
%.o : $(MATLAB_ROOT)/toolbox/comedi/%.cpp
	@$(GCC_TEST_CMD) $< $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) $<

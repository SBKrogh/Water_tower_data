...
% hold on 
 reduce_plot(data.pump_pressure(1,:),data.pump_pressure(5,:))
% hold on 
...
hold on 
plot(1800,data.pump_pressure(5,36000),'*r',3600,data.pump_pressure(5,72000),'r*')

data.pump_pressure(5,36000)
data.pump_pressure(5,36000*2)
